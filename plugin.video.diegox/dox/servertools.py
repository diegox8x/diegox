...
from dox import httptools, scrapertools, jsontools, filetools
    ...
    if server == "directo" or server == "local":
        ...
        if 'active' not in server_parameters:
            ...
            if config.get_setting('developer_mode', default=False):
                ...
                tools.dialog_notification(config.__addon_name, '[COLOR gold]' + errmsg)
                return [], False, ''
