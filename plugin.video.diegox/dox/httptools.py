...
try: from dox.cloudflare import Cloudflare
except: pass
...
# ~ 30/1/25
# ~ useragent = "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.6834.160 Safari/537.36"
useragent = "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.6943.35 Safari/537.36"
...
def downloadpage_proxy(canal,
    ...
    if not proxy_ok: 
        ...
        if avisar:
           ...
           tools.dialog_notification(el_canal, txt)
            ...
            if error_py3:
               ...
               if loglevel >= 2:
                   if config.get_setting('developer_mode', default=False):
                       tools.dialog_notification('ERROR PY3:  Check addinfourl', dominio + ' f_r=' + str(follow_redirects) + ' o_h=' + str(only_headers))
